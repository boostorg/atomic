...
#include <boost/atomic/detail/config.hpp>
    ...
    (defined(BOOST_CLANG) && !defined(BOOST_EMBTC) && !defined(__apple_build_version__) && (__clang_major__+0) < 8) ||\
    (defined(BOOST_CLANG) && !defined(BOOST_EMBTC) && defined(__apple_build_version__) && (__clang_major__+0) < 9)
