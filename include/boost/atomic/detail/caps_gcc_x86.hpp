...
#elif __SIZEOF_LONG__ == 8 && (defined(__x86_64__) || defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B))
#define BOOST_ATOMIC_LONG_LOCK_FREE 2
#endif
#else
#include <limits.h>
...
#define BOOST_ATOMIC_LONG_LOCK_FREE 2
#elif ULONG_MAX == 0xffffffffffffffff && (defined(__x86_64__) || defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B))
#define BOOST_ATOMIC_LONG_LOCK_FREE 2
#endif
#endif
