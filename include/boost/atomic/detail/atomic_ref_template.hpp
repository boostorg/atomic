...
public:
    static BOOST_CONSTEXPR_OR_CONST std::size_t required_alignment = atomics::detail::is_atomic_ref_lock_free< T, IsSigned >::value ? operations::storage_alignment : boost::alignment_of< value_type >::value;
